...
enum FwApplicationStates { launchingState, addWalletAddressState, balanceState, detailsState }
...
class FwMainModel extends FwModel {
  ...
  _stopRefresh() {
    if (_refreshStarted) {
      ...
      if (kDebugMode) {
        print("Balance: refresh stopped !");
      }
    }
  }

  void didChangeAppLifecycleState(AppLifecycleState state) {
    bool active = _currentPage == FwApplicationStates.balanceState || _currentPage == FwApplicationStates.detailsState;
